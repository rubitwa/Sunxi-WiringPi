...
struct SUNXIBoards sunxiboard [] = 
{
  ...
  { "opi-zero",	   20201, 39, 1, 3, 6, 0, pinToGpio_OPI_ZERO, physToGpio_OPI_ZERO, pinTobcm_OPI_ZERO, OPI_ZERO_I2C_DEV, OPI_ZERO_SPI_DEV, {OPI_ZERO_PWM_OFFSET,OPI_ZERO_I2C_OFFSET,OPI_ZERO_SPI_OFFSET} },
  { "opi-zerop",   20201, 40, 1, 3, 6, 0, pinToGpio_OPI_ZERO, physToGpio_OPI_ZERO, pinTobcm_OPI_ZERO, OPI_ZERO_I2C_DEV, OPI_ZERO_SPI_DEV, {OPI_ZERO_PWM_OFFSET,OPI_ZERO_I2C_OFFSET,OPI_ZERO_SPI_OFFSET} },
  { "opi-r1",	   20201, 41, 1, 3, 6, 0, pinToGpio_OPI_ZERO, physToGpio_OPI_ZERO, pinTobcm_OPI_ZERO, OPI_ZERO_I2C_DEV, OPI_ZERO_SPI_DEV, {OPI_ZERO_PWM_OFFSET,OPI_ZERO_I2C_OFFSET,OPI_ZERO_SPI_OFFSET} },

  { "opi-zerop2",   20301, 42, 1, 3, 6, 0, pinToGpio_OPI_ZEROP2, physToGpio_OPI_ZEROP2, pinTobcm_OPI_ZEROP2, OPI_ZEROP2_I2C_DEV, OPI_ZEROP2_SPI_DEV, {OPI_ZEROP2_PWM_OFFSET,OPI_ZEROP2_I2C_OFFSET,OPI_ZEROP2_SPI_OFFSET} },

  { "opi-onep",   20401, 43, 1, 2, 6, 0, pinToGpio_OPI_ONEP, physToGpio_OPI_ONEP, pinTobcm_OPI_ONEP, OPI_ONEP_I2C_DEV, OPI_ONEP_SPI_DEV, {OPI_ONEP_PWM_OFFSET,OPI_ONEP_I2C_OFFSET,OPI_ONEP_SPI_OFFSET} },
  { "opi-lite2",   20401, 44, 1, 2, 6, 0, pinToGpio_OPI_ONEP, physToGpio_OPI_ONEP, pinTobcm_OPI_ONEP, OPI_ONEP_I2C_DEV, OPI_ONEP_SPI_DEV, {OPI_ONEP_PWM_OFFSET,OPI_ONEP_I2C_OFFSET,OPI_ONEP_SPI_OFFSET} },
