...
struct SUNXIBoards sunxiboard [] = 
{
  ...
  { "opi-win",	   11101, 34, 1, 3, 6, 0, pinToGpio_OPI_WIN, physToGpio_OPI_WIN, pinTobcm_OPI_WIN, OPI_WIN_I2C_DEV, OPI_WIN_SPI_DEV, {OPI_WIN_PWM_OFFSET,OPI_WIN_I2C_OFFSET,OPI_WIN_SPI_OFFSET} },
